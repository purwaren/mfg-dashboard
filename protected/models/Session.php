...
class Session extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userid, session_key, valid_until, ip_address', 'required'),
			array('valid_until', 'numerical', 'integerOnly'=>true),
			array('session_key', 'length', 'max'=>32),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, userid, session_key, valid_until', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('valid_until',$this->valid_until);
